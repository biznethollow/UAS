<?php 
    ...
    $hasil2 = tampilSekolah(htmlspecialchars($_GET['id']));
    if(isset($_POST['submit'])) {
        editSekolah(htmlspecialchars($_GET['id']), htmlspecialchars($_POST['sekolah']));
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content">
        ...
        <form action="" method="POST">
            <div>
                ...
                <input type="text" name="sekolah" value="<?php echo $_POST['sekolah'] ?? $hasil2['nama_sekolah'] ?>" required>
            </div>
            <div>
