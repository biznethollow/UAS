<?php
    ...
    $hasil2 = tambahHistory($id, htmlspecialchars($_GET['id']));
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="content">
        <h1>Congratulations, You Has Completed <?php echo $hasil2['judul'] ?></h1>
        <div>
            <div>
                <h1>Flashcards Description</h1>
                <p><?php echo $hasil2['deskripsi'] ?></p>
            </div>
            <div>
                <h1>Your Score</h1>
                <p><?php echo $hasil2['skor'] ?></p> 
            </div>
        </div>
    </div>
</body>
