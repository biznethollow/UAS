<?php 
    ...
    if(isset($_POST['submit'])) {
        tambahJawaban($id1, htmlspecialchars($_POST['is_correct']), htmlspecialchars($_POST['jawaban']));
        header("location: /UAS/view/answer/add_answer.php?id=$id1&id2=$id");
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content">
        ...
        <form action="" method="POST" >
            <div>
                ...
                <input type="text" name="jawaban" value="<?php echo $_POST["jawaban"] ?? '' ?>">
            </div>
            <div>
                <span>Is This The Answer?</span>
                <?php if(empty($_POST['is_correct'])): ?>
                    <label for="1">
            ...
            <div>
                <a href="../flashcards/edit_flashcards.php?id=<?php echo htmlspecialchars($_GET['id']) ?>&id2=<?php echo htmlspecialchars($_GET['id2']) ?>">Back</a>
