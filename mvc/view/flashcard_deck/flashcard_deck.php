<?php 
    ...
    $hasil2 = cariFlashcardDeck($_SESSION['id_user']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="content">
        ...
        <a href="add_flashcard_deck.php">Add Flashcard Deck</a>
        <div>
            <?php foreach($hasil2 as $h): ?>
                <div>
                    <p><?php echo $h['judul'] ?></p>
                    <p><?php echo '"'.$h['deskripsi'].'"' ?></p>
                    <div>
                        <a href="edit_flashcard_deck.php?id=<?php echo $h['id_deck'] ?>">Edit</a>
                        <a href="../../controller/flashcard_deck/delete_flashcard_deck.php?id=<?php echo $h['id_deck'] ?>" onclick="return confirm('Are you want to delete <?php echo $h['judul'] ?>?')">Delete</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
